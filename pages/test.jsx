...
//             <p>{table.nickname}</p>
//             {table.visitors.map(visitor => (
//               <div key={visitor.visitor_name}>
...
//         ))} */}
//       {/* </div> */}
//       {/* {cakeData.visitors.map((visitor, index) => (
//   <div key={index}>
//     <p>방문자 이름: {visitor.visitor_name}</p>
//     <p>선택한 케이크: {visitor.pickcake}</p>
//   </div>
// ))} */}
// {cakeData.visitors && cakeData.visitors.map(visitor => (
//   <div key={visitor.visitor_name}>
//     <p>{visitor.visitor_name}</p>
//     <p>{visitor.pickcake}</p>
//     <p>{visitor.letter}</p>
